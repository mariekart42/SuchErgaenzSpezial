...
Weiter:
   ...
   'In the following loop the problem with two same word occure
                   'eg, 'my mum is cool@33'
                   'cool@44
                   '-> this would throw an error cause 2 times cool

    'Strings im Array miteinander vergleichen
    For m = 1 To i
        MsgBox("outer loop m: " & m)
        For n = 1 To i
            MsgBox("inner loop n: " & n)
