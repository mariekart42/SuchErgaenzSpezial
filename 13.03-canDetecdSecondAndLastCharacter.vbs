...
SuchErsetz:
            ...
            Do While selectionRange.Find.Execute(FindText:=suchstring & "??", MatchAllWordForms:=False, MatchSoundsLike:=False, MatchWildcards:=True, Forward:=True) = True
                ...
                If secondLastChar = "s" Then
                    ...
                    If Not IsNumeric(lastChar) Or IsLetter(lastChar) Then
